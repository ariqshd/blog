...
This repository is the Nextjs implementation of [hugo-ladder-theme](https://github.com/guangzhengli/hugo-theme-ladder).

This is a Nextjs blog template. Here are some basic uses of this template.
...
# Blog Configuration## 1. How to write a blog The blog files of this repository need to be placed in the `src/content/blog` directory. They can be markdown files or mdx files.
